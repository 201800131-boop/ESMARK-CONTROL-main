              ...
              <div style={styles.trelloDetailCard}>
                ...
                <div style={styles.trelloDetailGrid}>
                  ...
                  <div style={{ ...styles.trelloDetailItem, gridColumn: '1 / -1' }}>
                    <span style={styles.trelloDetailLabel}>Descripcion</span>
                    <span style={styles.trelloDetailDescription}>
                      {selectedCard.desc?.trim() ? selectedCard.desc : 'Sin descripcion en Trello.'}
                    </span>
                  </div>
                </div>
              </div>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  heroText: { color: 'rgba(255,255,255,.85)', fontSize: 13 },
  ...
  trelloBox: { border: '1px dashed #93c5fd', background: '#eff6ff', borderRadius: 10, padding: 10, marginBottom: 12 },
  trelloHeader: { fontSize: 12, fontWeight: 700, color: '#1d4ed8', marginBottom: 8, textTransform: 'uppercase' },
  trelloHeaderRow: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12, marginBottom: 10 },
  trelloHeaderTitle: { fontSize: 18, color: '#0f172a', fontWeight: 800, marginTop: 2 },
  trelloStatsRow: { display: 'grid', gridTemplateColumns: 'repeat(3, minmax(0, 1fr))', gap: 10, marginBottom: 10 },
  trelloStatCard: {
    background: '#fff',
  ...
  trelloToolbar: { display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: 10, marginBottom: 10 },
  trelloToolbarSecondary: { display: 'grid', gridTemplateColumns: '1fr auto', gap: 10, marginBottom: 10 },
  ...
  favoritesHeaderRow: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12, marginBottom: 10 },
  favoritesCount: { background: '#e0e7ff', color: '#312e81', borderRadius: 999, padding: '5px 10px', fontSize: 12, fontWeight: 700 },
  favoriteChips: { display: 'flex', flexWrap: 'wrap', gap: 8 },
  favoriteChip: {
    display: 'flex',
    flexDirection: 'column',
    gap: 2,
  ...
  trelloExplorer: { display: 'flex', flexDirection: 'column', gap: 10, marginTop: 4 },
  trelloGroup: { background: '#fff', border: '1px solid #bfdbfe', borderRadius: 12, overflow: 'hidden' },
  trelloGroupHeader: {
    display: 'flex',
  ...
  trelloGroupCount: { background: '#1d4ed8', color: '#fff', borderRadius: 999, padding: '3px 9px', fontSize: 12 },
  trelloCardGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 10, padding: 12 },
  trelloCardPill: {
    display: 'flex',
    flexDirection: 'column',
    gap: 4,
  ...
  trelloCardPillName: { fontSize: 14, fontWeight: 700, color: '#0f172a' },
  ...
  trelloMeta: { marginTop: 8, display: 'flex', gap: 12, fontSize: 12, color: '#334155', flexDirection: 'column' },
  trelloDetailCard: {
    background: '#fff',
  ...
  linkedCardPanel: { marginTop: 14, padding: 14, background: '#f0fdf4', border: '2px solid #86efac', borderRadius: 12 },
  linkedCardPanelHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 12, marginBottom: 12, paddingBottom: 12, borderBottom: '1px solid #86efac' },
  linkedCardPanelTitle: { fontSize: 15, fontWeight: 700, color: '#166534', margin: 0 },
  linkedCardGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 10 },
  linkedCardField: { display: 'flex', flexDirection: 'column', gap: 4, padding: 10, background: '#fff', borderRadius: 8, border: '1px solid #d1fae5' },
  ...
  formShell: { display: 'flex', flexDirection: 'column', gap: 16 },
  formSection: {
    background: '#f8fafc',
  ...
  sectionHeader: { display: 'flex', flexDirection: 'column', gap: 2, marginBottom: 12 },
